...
const { User, Customer, CustomerAddress, Product, Group, Option, MailSettings, UserRole } = require("../models");
...
const GroupType = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    products: {
      ...
      resolve(parent, args) {
        return Product.find({ groupId: parent._id, deleted: false }).sort("order");
      },
    },
    deleted: { type: GraphQLBoolean },
  }),
