...
router.route("/getGroups").post(roleCheck(Role.products), ProductPostsController.getGroups)
router.route("/getOptions").post(roleCheck(Role.products), ProductPostsController.getOptions)
